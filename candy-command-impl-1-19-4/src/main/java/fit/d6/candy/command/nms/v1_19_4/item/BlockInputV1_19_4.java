package fit.d6.candy.command.nms.v1_19_4.item;
...
public class BlockInputV1_19_4 implements BlockInput {

    private final net.minecraft.commands.arguments.blocks.BlockInput nmsInput;

    public BlockInputV1_19_4(net.minecraft.commands.arguments.blocks.BlockInput nms) {
        this.nmsInput = nms;
    }
