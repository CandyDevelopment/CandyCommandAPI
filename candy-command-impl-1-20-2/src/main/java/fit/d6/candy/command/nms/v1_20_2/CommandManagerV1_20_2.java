...
import fit.d6.candy.command.nms.v1_20_2.argument.ArgumentTypeV1_20_2;
...
public class CommandManagerV1_20_2 implements CommandManager {
    ...
    public CommandBuilder createCommand(String name) {
        return new LiteralCommandBuilderV1_20_2(name.toLowerCase());
    }

    @Override
    public CommandBuilder createCommand(String name, ArgumentType argumentType) {
        return new ArgumentBuilderV1_20_2(name.toLowerCase(), (ArgumentTypeV1_20_2) argumentType);
    }
    ...
    public Command register(String prefix, CommandBuilder builder) {
        ...
        CommandNode<CommandSourceStack> commandNode = ((CommandBuilderV1_20_2<?>) builder).toBrigadier().build();
        if (builder instanceof LiteralCommandBuilderV1_20_2) {
        ...
        Command command = new CommandV1_20_2(commandNode);
    ...
    public void onLoad(ServerLoadEvent event) {
        ...
        for (String prefix : REGISTERED.keySet()) {
            for (Command command : REGISTERED.get(prefix)) {
                CommandNode<CommandSourceStack> commandNode = ((CommandV1_20_2) command).toBrigadier();
