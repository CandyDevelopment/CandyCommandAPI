...
public class ArgumentBuilderV1_20_2 extends CommandBuilderV1_20_2<RequiredArgumentBuilder<CommandSourceStack, Object>> {

    private RequiredArgumentBuilder<CommandSourceStack, ?> brigadier;

    private final String name;
    private final ArgumentTypeV1_20_2 argumentType;
    ...
    public ArgumentBuilderV1_20_2(String name, ArgumentTypeV1_20_2 argumentType) {
    ...
    public CommandBuilder suggests(CommandSuggester suggester) {
        ...
        if (suggester == null) {
            ...
            this.brigadier.suggests((commandContext, suggestionsBuilder) -> {
                CommandContext context = new CommandContextV1_20_2(commandContext);
                CommandArgumentHelper argument = new CommandArgumentHelperV1_20_2(commandContext);
                CommandSuggestion suggestion = new CommandSuggestionV1_20_2(suggestionsBuilder);
