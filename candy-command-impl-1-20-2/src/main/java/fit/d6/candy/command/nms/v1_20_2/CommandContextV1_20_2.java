...
public class CommandContextV1_20_2 implements CommandContext {

    private final com.mojang.brigadier.context.CommandContext<CommandSourceStack> brigadier;

    public CommandContextV1_20_2(com.mojang.brigadier.context.CommandContext<CommandSourceStack> brigadier) {
        this.brigadier = brigadier;
    }

    @Override
    public CommandArgumentHelper getArgument() {
        return new CommandArgumentHelperV1_20_2(this.brigadier);
    }
    ...
    public boolean isPlayer() {
        return this.brigadier.getSource().isPlayer();
    }
