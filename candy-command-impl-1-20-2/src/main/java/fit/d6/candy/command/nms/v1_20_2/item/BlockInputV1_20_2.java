package fit.d6.candy.command.nms.v1_20_2.item;
...
public class BlockInputV1_20_2 implements BlockInput {

    private final net.minecraft.commands.arguments.blocks.BlockInput nmsInput;

    public BlockInputV1_20_2(net.minecraft.commands.arguments.blocks.BlockInput nms) {
        this.nmsInput = nms;
    }
