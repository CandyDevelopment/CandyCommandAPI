...
public class CommandContextV1_14_4 implements CommandContext {

    private final com.mojang.brigadier.context.CommandContext<CommandListenerWrapper> brigadier;

    public CommandContextV1_14_4(com.mojang.brigadier.context.CommandContext<CommandListenerWrapper> brigadier) {
        this.brigadier = brigadier;
    }

    @Override
    public CommandArgumentHelper getArgument() {
        return new CommandArgumentHelperV1_14_4(this.brigadier);
    }
