...
public class ArgumentBuilderV1_14_4 extends CommandBuilderV1_14_4<RequiredArgumentBuilder<CommandListenerWrapper, Object>> {

    private final RequiredArgumentBuilder<CommandListenerWrapper, ?> brigadier;

    private final String name;
    private final ArgumentTypeV1_14_4 argumentType;
    ...
    public ArgumentBuilderV1_14_4(String name, ArgumentTypeV1_14_4 argumentType) {
    ...
    public CommandBuilder suggests(CommandSuggester suggester) {
        ...
        if (suggester == null) {
            ...
            this.brigadier.suggests((commandContext, suggestionsBuilder) -> {
                CommandContext context = new CommandContextV1_14_4(commandContext);
                CommandArgumentHelper argument = new CommandArgumentHelperV1_14_4(commandContext);
                CommandSuggestion suggestion = new CommandSuggestionV1_14_4(suggestionsBuilder);
