...
import fit.d6.candy.command.nms.v1_18.argument.ArgumentTypeV1_18;
...
public class ArgumentBuilderV1_18 extends CommandBuilderV1_18<RequiredArgumentBuilder<CommandSourceStack, Object>> {

    private RequiredArgumentBuilder<CommandSourceStack, ?> brigadier;

    private final String name;
    private final ArgumentTypeV1_18 argumentType;
    ...
    public ArgumentBuilderV1_18(String name, ArgumentTypeV1_18 argumentType) {
    ...
    public CommandBuilder then(CommandNode nextNode) {
        if (nextNode instanceof CommandV1_18) {
            this.brigadier.then(((CommandV1_18) nextNode).toBrigadier());
        } else if (nextNode instanceof CommandBuilderV1_18<?>) {
            this.brigadier.then(((CommandBuilderV1_18) nextNode).toBrigadier());
        } else {
            return this;
        }
    ...
    private void checkExecutor() {
        if (this.executor == null && this.playerExecutor == null) {
            ...
            this.brigadier.executes(context -> {
                CommandContext candyContext = new CommandContextV1_18(context);
                CommandArgumentHelper argumentHelper = new CommandArgumentHelperV1_18(context);
    ...
    public CommandBuilder suggests(CommandSuggester suggester) {
        ...
        if (suggester == null) {
            ...
            this.brigadier.suggests((commandContext, suggestionsBuilder) -> {
                CommandContext context = new CommandContextV1_18(commandContext);
                CommandArgumentHelper argument = new CommandArgumentHelperV1_18(commandContext);
                CommandSuggestion suggestion = new CommandSuggestionV1_18(suggestionsBuilder);
    ...
    public CommandBuilder redirects(Command redirection) {
        ...
        if (redirection != null) {
            this.brigadier.redirect(((CommandV1_18) redirection).toBrigadier());
        } else {
