package fit.d6.candy.command.nms.v1_18.item;
...
public class BlockInputV1_18 implements BlockInput {

    private final net.minecraft.commands.arguments.blocks.BlockInput nmsInput;

    public BlockInputV1_18(net.minecraft.commands.arguments.blocks.BlockInput nms) {
        this.nmsInput = nms;
    }
