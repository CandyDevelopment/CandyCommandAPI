...
import fit.d6.candy.command.nms.v1_19_1.argument.ArgumentTypeV1_19_1;
...
public class ArgumentBuilderV1_19_1 extends CommandBuilderV1_19_1<RequiredArgumentBuilder<CommandSourceStack, Object>> {

    private RequiredArgumentBuilder<CommandSourceStack, ?> brigadier;

    private final String name;
    private final ArgumentTypeV1_19_1 argumentType;
    ...
    public ArgumentBuilderV1_19_1(String name, ArgumentTypeV1_19_1 argumentType) {
    ...
    public CommandBuilder then(CommandNode nextNode) {
        if (nextNode instanceof CommandV1_19_1) {
            this.brigadier.then(((CommandV1_19_1) nextNode).toBrigadier());
        } else if (nextNode instanceof CommandBuilderV1_19_1<?>) {
            this.brigadier.then(((CommandBuilderV1_19_1) nextNode).toBrigadier());
        } else {
            return this;
        }
    ...
    private void checkExecutor() {
        if (this.executor == null && this.playerExecutor == null) {
            ...
            this.brigadier.executes(context -> {
                CommandContext candyContext = new CommandContextV1_19_1(context);
                CommandArgumentHelper argumentHelper = new CommandArgumentHelperV1_19_1(context);
    ...
    public CommandBuilder suggests(CommandSuggester suggester) {
        ...
        if (suggester == null) {
            ...
            this.brigadier.suggests((commandContext, suggestionsBuilder) -> {
                CommandContext context = new CommandContextV1_19_1(commandContext);
                CommandArgumentHelper argument = new CommandArgumentHelperV1_19_1(commandContext);
                CommandSuggestion suggestion = new CommandSuggestionV1_19_1(suggestionsBuilder);
    ...
    public CommandBuilder redirects(Command redirection) {
        ...
        if (redirection != null) {
            this.brigadier.redirect(((CommandV1_19_1) redirection).toBrigadier());
        } else {
