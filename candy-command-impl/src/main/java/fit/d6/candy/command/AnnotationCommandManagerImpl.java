...
public class AnnotationCommandManagerImpl implements AnnotationCommandManager {

    @Override
    public Command register(Object command) {
        return this.register("candycmd", command);
    }

    @Override
    public Command register(String prefix, Object command) {
        CommandBuilder commandBuilder = this.analyseCommand(command);
        return CommandService.getService().getCommandManager().register(prefix, commandBuilder);
    }
    ...
    private CommandBuilder analyseCommand(Object command) {
        ...
        CommandBuilder baseBuilder = CommandService.getService().getCommandManager().createCommand(commandAnnotation.name());
        ...
        for (Method method : commandClass.getDeclaredMethods()) {
            ...
            CommandBuilder toUseBuilder = subCmd == null ? baseBuilder : CommandService.getService().getCommandManager().createCommand(subCmd.name());
