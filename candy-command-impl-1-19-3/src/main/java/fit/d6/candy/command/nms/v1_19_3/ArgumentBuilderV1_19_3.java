...
public class ArgumentBuilderV1_19_3 extends CommandBuilderV1_19_3<RequiredArgumentBuilder<CommandSourceStack, Object>> {

    private RequiredArgumentBuilder<CommandSourceStack, ?> brigadier;

    private final String name;
    private final ArgumentTypeV1_19_3 argumentType;
    ...
    public ArgumentBuilderV1_19_3(String name, ArgumentTypeV1_19_3 argumentType) {
    ...
    public CommandBuilder then(CommandNode nextNode) {
        if (nextNode instanceof CommandV1_19_3) {
            this.brigadier.then(((CommandV1_19_3) nextNode).toBrigadier());
        } else if (nextNode instanceof CommandBuilderV1_19_3<?>) {
            this.brigadier.then(((CommandBuilderV1_19_3) nextNode).toBrigadier());
        } else {
            return this;
        }
    ...
    private void checkExecutor() {
        if (this.executor == null && this.playerExecutor == null) {
            ...
            this.brigadier.executes(context -> {
                CommandContext candyContext = new CommandContextV1_19_3(context);
                CommandArgumentHelper argumentHelper = new CommandArgumentHelperV1_19_3(context);
    ...
    public CommandBuilder suggests(CommandSuggester suggester) {
        ...
        if (suggester == null) {
            ...
            this.brigadier.suggests((commandContext, suggestionsBuilder) -> {
                CommandContext context = new CommandContextV1_19_3(commandContext);
                CommandArgumentHelper argument = new CommandArgumentHelperV1_19_3(commandContext);
                CommandSuggestion suggestion = new CommandSuggestionV1_19_3(suggestionsBuilder);
    ...
    public CommandBuilder redirects(Command redirection) {
        ...
        if (redirection != null) {
            this.brigadier.redirect(((CommandV1_19_3) redirection).toBrigadier());
        } else {
