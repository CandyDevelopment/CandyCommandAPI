...
public class CommandContextV1_18_2 implements CommandContext {

    private final com.mojang.brigadier.context.CommandContext<CommandSourceStack> brigadier;

    public CommandContextV1_18_2(com.mojang.brigadier.context.CommandContext<CommandSourceStack> brigadier) {
        this.brigadier = brigadier;
    }

    @Override
    public CommandArgumentHelper getArgument() {
        return new CommandArgumentHelperV1_18_2(this.brigadier);
    }
