...
public class CommandContextV1_20 implements CommandContext {

    private final com.mojang.brigadier.context.CommandContext<CommandSourceStack> brigadier;

    public CommandContextV1_20(com.mojang.brigadier.context.CommandContext<CommandSourceStack> brigadier) {
        this.brigadier = brigadier;
    }

    @Override
    public CommandArgumentHelper getArgument() {
        return new CommandArgumentHelperV1_20(this.brigadier);
    }
