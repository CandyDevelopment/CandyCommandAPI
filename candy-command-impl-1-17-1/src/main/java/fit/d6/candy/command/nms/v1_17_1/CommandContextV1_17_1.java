...
public class CommandContextV1_17_1 implements CommandContext {

    private final com.mojang.brigadier.context.CommandContext<CommandSourceStack> brigadier;

    public CommandContextV1_17_1(com.mojang.brigadier.context.CommandContext<CommandSourceStack> brigadier) {
        this.brigadier = brigadier;
    }

    @Override
    public CommandArgumentHelper getArgument() {
        return new CommandArgumentHelperV1_17_1(this.brigadier);
    }
