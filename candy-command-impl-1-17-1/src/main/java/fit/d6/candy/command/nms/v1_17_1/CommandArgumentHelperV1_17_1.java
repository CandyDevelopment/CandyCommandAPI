...
import fit.d6.candy.command.nms.v1_17_1.item.BlockInputV1_17_1;
import fit.d6.candy.command.nms.v1_17_1.item.ItemInputV1_17_1;
...
class CommandArgumentHelperV1_17_1 implements CommandArgumentHelper {

    private final CommandContext<CommandSourceStack> commandContext;

    public CommandArgumentHelperV1_17_1(CommandContext<CommandSourceStack> context) {
    ...
    public BlockInput getBlock(String name) {
        return new BlockInputV1_17_1(BlockStateArgument.getBlock(this.commandContext, name));
    }

    @Override
    public ItemInput getItem(String name) {
        return new ItemInputV1_17_1(ItemArgument.getItem(this.commandContext, name));
    }
    ...
    public PotionEffectType getPotionEffectType(String name) throws CommandSyntaxException {
        return CraftPotionEffectType.getById(MobEffect.getId(MobEffectArgument.getEffect(this.commandContext, name)));
    }
