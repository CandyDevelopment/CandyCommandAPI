...
import fit.d6.candy.nms.v1_17_1.argument.ArgumentTypeV1_17_1;
...
public class CommandManagerV1_17_1 implements CommandManager {
    ...
    public CommandBuilder createCommand(String name) {
        return new LiteralCommandBuilderV1_17_1(name.toLowerCase());
    }

    @Override
    public CommandBuilder createCommand(String name, ArgumentType argumentType) {
        return new ArgumentBuilderV1_17_1(name.toLowerCase(), (ArgumentTypeV1_17_1) argumentType);
    }
    ...
    public Command register(String prefix, CommandBuilder builder) {
        ...
        CommandNode<CommandSourceStack> commandNode = ((CommandBuilderV1_17_1<?>) builder).toBrigadier().build();
        if (builder instanceof LiteralCommandBuilderV1_17_1) {
        ...
        Command command = new CommandV1_17_1(commandNode);
    ...
    public void onLoad(ServerLoadEvent event) {
        ...
        for (String prefix : REGISTERED.keySet()) {
            for (Command command : REGISTERED.get(prefix)) {
                CommandNode<CommandSourceStack> commandNode = ((CommandV1_17_1) command).toBrigadier();
