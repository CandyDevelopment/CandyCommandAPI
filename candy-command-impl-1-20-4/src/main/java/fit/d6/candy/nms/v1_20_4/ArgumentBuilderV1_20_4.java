...
import fit.d6.candy.nms.v1_20_4.argument.ArgumentTypeV1_20_4;
...
public class ArgumentBuilderV1_20_4 extends CommandBuilderV1_20_4<RequiredArgumentBuilder<CommandSourceStack, Object>> {

    private RequiredArgumentBuilder<CommandSourceStack, ?> brigadier;

    private final String name;
    private final ArgumentTypeV1_20_4 argumentType;
    ...
    public ArgumentBuilderV1_20_4(String name, ArgumentTypeV1_20_4 argumentType) {
    ...
    public CommandBuilder then(CommandNode nextNode) {
        if (nextNode instanceof CommandV1_20_4) {
            this.brigadier.then(((CommandV1_20_4) nextNode).toBrigadier());
        } else if (nextNode instanceof CommandBuilderV1_20_4<?>) {
            this.brigadier.then(((CommandBuilderV1_20_4) nextNode).toBrigadier());
        } else {
            return this;
        }
    ...
    private void checkExecutor() {
        if (this.executor == null && this.playerExecutor == null) {
            ...
            this.brigadier.executes(context -> {
                CommandContext candyContext = new CommandContextV1_20_4(context);
                CommandArgumentHelper argumentHelper = new CommandArgumentHelperV1_20_4(context);
    ...
    public CommandBuilder suggests(CommandSuggester suggester) {
        ...
        if (suggester == null) {
            ...
            this.brigadier.suggests((commandContext, suggestionsBuilder) -> {
                CommandContext context = new CommandContextV1_20_4(commandContext);
                CommandArgumentHelper argument = new CommandArgumentHelperV1_20_4(commandContext);
                CommandSuggestion suggestion = new CommandSuggestionV1_20_4(suggestionsBuilder);
    ...
    public CommandBuilder redirects(Command redirection) {
        ...
        if (redirection != null) {
            this.brigadier.redirect(((CommandV1_20_4) redirection).toBrigadier());
        } else {
