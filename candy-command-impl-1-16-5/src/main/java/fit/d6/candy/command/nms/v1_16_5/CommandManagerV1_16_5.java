...
public class CommandManagerV1_16_5 implements CommandManager {
    ...
    public CommandBuilder createCommand(String name) {
        return new LiteralCommandBuilderV1_16_5(name.toLowerCase());
    }

    @Override
    public CommandBuilder createCommand(String name, ArgumentType argumentType) {
        return new ArgumentBuilderV1_16_5(name.toLowerCase(), (ArgumentTypeV1_16_5) argumentType);
    }
    ...
    public Command register(String prefix, CommandBuilder builder) {
        ...
        CommandNode<CommandListenerWrapper> commandNode = ((CommandBuilderV1_16_5<?>) builder).toBrigadier().build();
        if (builder instanceof LiteralCommandBuilderV1_16_5) {
        ...
        Command command = new CommandV1_16_5(commandNode);
    ...
    public void onLoad(ServerLoadEvent event) {
        ...
        for (String prefix : REGISTERED.keySet()) {
            for (Command command : REGISTERED.get(prefix)) {
                CommandNode<CommandListenerWrapper> commandNode = ((CommandV1_16_5) command).toBrigadier();
