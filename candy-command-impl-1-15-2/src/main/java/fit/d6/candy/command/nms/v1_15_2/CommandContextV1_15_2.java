...
public class CommandContextV1_15_2 implements CommandContext {

    private final com.mojang.brigadier.context.CommandContext<CommandListenerWrapper> brigadier;

    public CommandContextV1_15_2(com.mojang.brigadier.context.CommandContext<CommandListenerWrapper> brigadier) {
        this.brigadier = brigadier;
    }

    @Override
    public CommandArgumentHelper getArgument() {
        return new CommandArgumentHelperV1_15_2(this.brigadier);
    }
