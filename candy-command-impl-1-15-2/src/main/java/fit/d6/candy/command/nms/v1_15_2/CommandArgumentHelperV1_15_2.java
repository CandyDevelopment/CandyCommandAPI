...
import fit.d6.candy.command.nms.v1_15_2.item.BlockInputV1_15_2;
import fit.d6.candy.command.nms.v1_15_2.item.ItemInputV1_15_2;
...
class CommandArgumentHelperV1_15_2 implements CommandArgumentHelper {

    private final CommandContext<CommandListenerWrapper> commandContext;

    public CommandArgumentHelperV1_15_2(CommandContext<CommandListenerWrapper> context) {
    ...
    public Set<Entity> getEntities(String name) throws CommandSyntaxException {
        return ArgumentEntity.b(this.commandContext, name).stream().map(net.minecraft.server.v1_15_R1.Entity::getBukkitEntity).collect(Collectors.toSet());
    }

    @Override
    public Set<Entity> getOptionalEntities(String name) throws CommandSyntaxException {
        return ArgumentEntity.c(this.commandContext, name).stream().map(net.minecraft.server.v1_15_R1.Entity::getBukkitEntity).collect(Collectors.toSet());
    }
    ...
    public BlockInput getBlock(String name) {
        return new BlockInputV1_15_2(ArgumentTile.a(this.commandContext, name));
    }

    @Override
    public ItemInput getItem(String name) {
        return new ItemInputV1_15_2(ArgumentItemStack.a(this.commandContext, name));
    }
