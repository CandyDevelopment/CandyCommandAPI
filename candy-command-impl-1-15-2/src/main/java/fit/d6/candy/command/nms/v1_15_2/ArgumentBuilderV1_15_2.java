...
import fit.d6.candy.command.nms.v1_15_2.argument.ArgumentTypeV1_15_2;
...
public class ArgumentBuilderV1_15_2 extends CommandBuilderV1_15_2<RequiredArgumentBuilder<CommandListenerWrapper, Object>> {

    private final RequiredArgumentBuilder<CommandListenerWrapper, ?> brigadier;

    private final String name;
    private final ArgumentTypeV1_15_2 argumentType;
    ...
    public ArgumentBuilderV1_15_2(String name, ArgumentTypeV1_15_2 argumentType) {
    ...
    public CommandBuilder then(CommandNode nextNode) {
        if (nextNode instanceof CommandV1_15_2) {
            this.brigadier.then(((CommandV1_15_2) nextNode).toBrigadier());
        } else if (nextNode instanceof CommandBuilderV1_15_2<?>) {
            this.brigadier.then(((CommandBuilderV1_15_2) nextNode).toBrigadier());
        } else {
            return this;
        }
    ...
    private void checkExecutor() {
        if (this.executor == null && this.playerExecutor == null) {
            ...
            this.brigadier.executes(context -> {
                CommandContext candyContext = new CommandContextV1_15_2(context);
                CommandArgumentHelper argumentHelper = new CommandArgumentHelperV1_15_2(context);
    ...
    public CommandBuilder suggests(CommandSuggester suggester) {
        ...
        if (suggester == null) {
            ...
            this.brigadier.suggests((commandContext, suggestionsBuilder) -> {
                CommandContext context = new CommandContextV1_15_2(commandContext);
                CommandArgumentHelper argument = new CommandArgumentHelperV1_15_2(commandContext);
                CommandSuggestion suggestion = new CommandSuggestionV1_15_2(suggestionsBuilder);
    ...
    public CommandBuilder redirects(Command redirection) {
        ...
        if (redirection != null) {
            this.brigadier.redirect(((CommandV1_15_2) redirection).toBrigadier());
        } else {
